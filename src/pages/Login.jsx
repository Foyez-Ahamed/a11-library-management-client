  ...
  return (
    <div className="mt-16">
      <div className="flex justify-center items-center">
        <div className="shadow-xl p-8 w-full md:w-[450px] lg:w-[450px] bg-slate-100 dark:bg-zinc-900 rounded-xl">
          <div>
          ...
          <button
            ...
            className=" bg-[#0087EB] hover:bg-slate-900 flex gap-2 justify-center items-center w-full py-3 rounded-md mt-5 text-white text-[15px] font-medium uppercase"
          >
